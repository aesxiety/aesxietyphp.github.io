...
$formattedDate = $date->format('l, d M Y H:i:s'); 

$gmtOffset = $localTimezone->getOffset($date) / 3600;
$gmtFormatted = sprintf('%+03d:%02d', $gmtOffset, abs(($gmtOffset - (int)$gmtOffset) * 60));

$localTimezoneName = $date->format('e'); 
...
<body>
        ...
        <div class="nav-bar">
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="formkredit.php">Pengajuan Kredit</a></li>
                    <li><a href="#price-list">Price List</a></li>
                    <li><a href="ServiceBooking.php">Services</a></li>
    ...
    <script>
        ...
        // Dapatkan elemen ikon pengguna dan dropdown menu
        const userIcon = document.getElementById("user-icon");
        const userDropdown = document.getElementById("user-dropdown");

        // Tambahkan event listener untuk ikon pengguna
        ...
        // Sembunyikan dropdown saat di luar elemen ikon pengguna
        ...
        // Hentikan event klik pada dropdown agar tidak menutupnya
    ...
    <section class="content" id="slider-text">
        ...
        Waktu lokal di area Anda: <?php echo $formattedDate; ?> (GMT <?php echo $gmtFormatted; ?>) | <b>
...
<!-- akhir section aboutme-->
    ...
    <div id="popup-ad" class="popup">
        ...
        <p>Promo Spesial bulan Oktober khusus untukmu DP 10% menggunakan Leasing kerjasama kami</p>
    ...
    <script>
        ...
        window.location.href = 'formkredit.php';
        }
