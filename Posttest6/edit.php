...
if (isset($_GET["id"])) {
    ...
    $query = "SELECT * FROM form_kredit WHERE id = $id";
    $result = mysqli_query($conn, $query);
    
    if ($result) {
        $data_kredit = mysqli_fetch_assoc($result);
    } else {
...
<body>
    <section class="container">
        ...
        <div class="tagline-form">
            <h3>Selamat Datang di Promo Kredit Toyota!</h3>
            <h5>
        ...
        <form action="process.php" method="post" class="form">
            <div class="flex-container">
                <div class="left-form">
                    <input name="id" type="number" hidden value="<?= $id ?>">
                    <div class="input-box">
